...
function FanForm(props) {
    ...
    const submitFormAction = async () => {
        let url = API_BASE_URL+"sign-up/fan";
        let passFormData = {
    ...
    return <div className={styles.FormWrap}>
        <Typography variant='h5' align="center" className={styles.formtitle}>Create Your Fan Account</Typography>
